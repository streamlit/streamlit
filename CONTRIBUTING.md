...
| `triaging-issues` | When given a GitHub issue to take end-to-end — orchestrates reproduction, verdict review, and optional agent-wiki publication |
| `reproducing-issues` | When given a GitHub issue to reproduce, triage, or verify — prepares canonical agent-wiki artifacts and local evidence without publishing |
| `publishing-issue-repros` | When publishing prepared issue artifacts to streamlit.wiki for discovery by issues.streamlit.app |

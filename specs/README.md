...
5. Merging requires at least two approvals from core maintainers.
   - If approved: Maintainers will assign the final number, rename the directory, update the Status to Approved, merge the PR, and link the spec in related issues. The spec is considered ready for implementation.

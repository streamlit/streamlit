...
ifndef CIRCLECI
	...
	mkdir -p frontend/st-lib/src/autogen
	mkdir -p frontend/st-app/src/autogen
	...
	) > ./st-lib/src/autogen/proto.js

	@# Typescript type declarations for our generated protobufs
	cd frontend/ ; ( \
		echo "/* eslint-disable */" ; \
		echo ; \
		yarn --silent pbts ./st-lib/src/autogen/proto.js \
	) > ./st-lib/src/autogen/proto.d.ts

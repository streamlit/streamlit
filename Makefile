...
ifndef CIRCLECI
	...
	mkdir -p frontend/lib/src/autogen
	...
	) > ./lib/src/autogen/proto.js

	@# Typescript type declarations for our generated protobufs
	cd frontend/ ; ( \
		echo "/* eslint-disable */" ; \
		echo ; \
		yarn --silent pbts ./lib/src/autogen/proto.js \
	) > ./lib/src/autogen/proto.d.ts
...
notices:
	...
	sed -i "" "s/PORTIONS OF THE .*PRODUCT/PORTIONS OF THE STREAMLIT PRODUCT/" NOTICES

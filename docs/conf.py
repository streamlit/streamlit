...
latex_documents = [
    (master_doc, 'Streamlit.tex', u'Streamlit Documentation',
     u'Streamlit Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'streamlit', u'Streamlit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Streamlit', u'Streamlit Documentation',
     author, 'Streamlit', 'One line description of project.',
     'Miscellaneous'),
]

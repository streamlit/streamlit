# Welcome to Streamlit! We'll show you a few commands to get started
# Start by opening a browser next to your IDE and then run '$ python hello.py'
# You should now see the code below running live!
...
# Import Streamlit as st and have at least one st.() call to launch a report
...
st.title('Your first Streamlit report')
st.subheader('Watch while you train a CNN on the MNIST digit set.')
st.write('Add text, loss / accuracy graphs, training logs, progress bars, and output examples to understand your model as it builds.')
st.write('When you\'re done, click through to see [more example reports and documentation](https://streamlit.io/secret/docs).')

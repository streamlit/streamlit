  ...
  return (function(t) {
        ...
        decode: function(t, e) {
          ...
          if (!this._streaming) {
            do {
              ...
              null !== n &&
                (Array.isArray(n) ? u.push.apply(u, n) : u.push(n));
            } while (!s.endOfStream());
            this._decoder = null;
          }
          return (
    ...
    function(t, e, r) {
      ...
      class Gt {
        ...
        reserve(t) {
          if (t > 0) {
            ...
            r >= n &&
              this._resize(
                Kt(0 === n ? 1 * r : 2 * r, this.BYTES_PER_ELEMENT)
              );
          }
          return this;
        }
      ...
      class te {
        ...
        set(t, e) {
          return (
            this.setValid(t, this.isValid(e)) && this.setValue(t, e), this
          );
        }
        setValue(t, e) {
      ...
      class ee extends te {
        constructor(t) {
          super(t),
            (this._values = new qt(new this.ArrayType(0), this.stride));
        }
        setValue(t, e) {
      ...
      function mr(t, e, r) {
        const n = r[Symbol.iterator](),
          ...
          s =
            e instanceof Map
              ? e.values()
              : Object.values(e)[Symbol.iterator]();
        let o = 0,
          a = t.length,
          u = s.next(),
          c = n.next(),
      ...
      class Ln {
        ...
        async throw(t) {
          const e =
            (this.source.throw && (await this.source.throw(t))) || Sn.c;
          return (
      ...
      const qo = new Jo(),
        Zo = (t, e) => t + e,
        Xo = t =>
          `Cannot compute the byte width of variable-width column ${t}`;
        ...
        (us.throughDOM = function(t, e) {
          ...
          async function s(t) {
            ...
            for (; (e = await n.read(r || null)); )
              if ((t.enqueue(e), null != r && (r -= e.byteLength) <= 0))
                return;
            t.close();
          }
        });

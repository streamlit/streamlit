...
DISALLOWED_SNAPSHOTS = {
    ...
    "st_chat_input-file_chip_archive[dark_theme-chromium-archive].png",
    "st_chat_input-file_chip_archive[dark_theme-firefox-archive].png",
    "st_chat_input-file_chip_archive[dark_theme-webkit-archive].png",
    "st_chat_input-file_chip_archive[light_theme-chromium-archive].png",
    "st_chat_input-file_chip_archive[light_theme-firefox-archive].png",
    "st_chat_input-file_chip_archive[light_theme-webkit-archive].png",
    "st_chat_input-file_chip_audio[dark_theme-chromium-audio].png",
    "st_chat_input-file_chip_audio[dark_theme-firefox-audio].png",
    "st_chat_input-file_chip_audio[dark_theme-webkit-audio].png",
    "st_chat_input-file_chip_audio[light_theme-chromium-audio].png",
    "st_chat_input-file_chip_audio[light_theme-firefox-audio].png",
    "st_chat_input-file_chip_audio[light_theme-webkit-audio].png",
    "st_chat_input-file_chip_code[dark_theme-chromium-code].png",
    "st_chat_input-file_chip_code[dark_theme-firefox-code].png",
    "st_chat_input-file_chip_code[dark_theme-webkit-code].png",
    "st_chat_input-file_chip_code[light_theme-chromium-code].png",
    "st_chat_input-file_chip_code[light_theme-firefox-code].png",
    "st_chat_input-file_chip_code[light_theme-webkit-code].png",
    "st_chat_input-file_chip_image[dark_theme-chromium-image].png",
    "st_chat_input-file_chip_image[dark_theme-firefox-image].png",
    "st_chat_input-file_chip_image[dark_theme-webkit-image].png",
    "st_chat_input-file_chip_image[light_theme-chromium-image].png",
    "st_chat_input-file_chip_image[light_theme-firefox-image].png",
    "st_chat_input-file_chip_image[light_theme-webkit-image].png",
    "st_chat_input-file_chip_pdf[dark_theme-chromium-pdf].png",
    "st_chat_input-file_chip_pdf[dark_theme-firefox-pdf].png",
    "st_chat_input-file_chip_pdf[dark_theme-webkit-pdf].png",
    "st_chat_input-file_chip_pdf[light_theme-chromium-pdf].png",
    "st_chat_input-file_chip_pdf[light_theme-firefox-pdf].png",
    "st_chat_input-file_chip_pdf[light_theme-webkit-pdf].png",
    "st_chat_input-file_chip_spreadsheet[dark_theme-chromium-spreadsheet].png",
    "st_chat_input-file_chip_spreadsheet[dark_theme-firefox-spreadsheet].png",
    "st_chat_input-file_chip_spreadsheet[dark_theme-webkit-spreadsheet].png",
    "st_chat_input-file_chip_spreadsheet[light_theme-chromium-spreadsheet].png",
    "st_chat_input-file_chip_spreadsheet[light_theme-firefox-spreadsheet].png",
    "st_chat_input-file_chip_spreadsheet[light_theme-webkit-spreadsheet].png",
    "st_chat_input-file_chip_text[dark_theme-chromium-text].png",
    "st_chat_input-file_chip_text[dark_theme-firefox-text].png",
    "st_chat_input-file_chip_text[dark_theme-webkit-text].png",
    "st_chat_input-file_chip_text[light_theme-chromium-text].png",
    "st_chat_input-file_chip_text[light_theme-firefox-text].png",
    "st_chat_input-file_chip_text[light_theme-webkit-text].png",
    "st_chat_input-file_chip_truncated[dark_theme-chromium-truncated].png",
    "st_chat_input-file_chip_truncated[dark_theme-firefox-truncated].png",
    "st_chat_input-file_chip_truncated[dark_theme-webkit-truncated].png",
    "st_chat_input-file_chip_truncated[light_theme-chromium-truncated].png",
    "st_chat_input-file_chip_truncated[light_theme-firefox-truncated].png",
    "st_chat_input-file_chip_truncated[light_theme-webkit-truncated].png",
    "st_chat_input-file_chip_unknown[dark_theme-chromium-unknown].png",
    "st_chat_input-file_chip_unknown[dark_theme-firefox-unknown].png",
    "st_chat_input-file_chip_unknown[dark_theme-webkit-unknown].png",
    "st_chat_input-file_chip_unknown[light_theme-chromium-unknown].png",
    "st_chat_input-file_chip_unknown[light_theme-firefox-unknown].png",
    "st_chat_input-file_chip_unknown[light_theme-webkit-unknown].png",
    "st_chat_input-file_chip_video[dark_theme-chromium-video].png",
    "st_chat_input-file_chip_video[dark_theme-firefox-video].png",
    "st_chat_input-file_chip_video[dark_theme-webkit-video].png",
    "st_chat_input-file_chip_video[light_theme-chromium-video].png",
    "st_chat_input-file_chip_video[light_theme-firefox-video].png",
    "st_chat_input-file_chip_video[light_theme-webkit-video].png",
}

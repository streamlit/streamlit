...
curl "https://cdn.pydata.org/bokeh/release/bokeh-tables-2.4.1.min.js" -o "bokeh-tables-2.4.1.min.js"
curl "https://cdn.pydata.org/bokeh/release/bokeh-api-2.4.1.min.js" -o "bokeh-api-2.4.1.min.js"

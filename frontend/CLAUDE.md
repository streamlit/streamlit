...
- [Key TypeScript Principles](#key-typescript-principles)
- [Key Frontend Principles](#key-frontend-principles)
...
- `make frontend-tests` - Run frontend unit tests and generate coverage report.

...
export type ElementProviderProps = PropsWithChildren<{
  width: number
}>

/**
 * Provides all of the necessary contexts for shared concepts. to render a
 * Streamlit element. More contexts can be added here as needed.
 */
export const ElementProvider: FC<ElementProviderProps> = ({
  children,
  width,
}) => {
  return (

...
import { generateDefaultTooltipOverrides } from "./Tooltip"

describe("generateDefaultTooltipOverrides", () => {
  it("adds theme CSS variables to the tooltip portal body", () => {
    const overrides = generateDefaultTooltipOverrides(mockTheme.emotion)

      ...
      overrides={{
        Body: {
          style: {
            ...
            marginLeft: 0,
            marginRight: 0,
            paddingTop: inModal ? spacing.xl : null,
            paddingBottom: inModal ? spacing.threeXL : null,
            paddingLeft: inModal ? spacing.xl : null,
            paddingRight: inModal ? spacing.fourXL : null,

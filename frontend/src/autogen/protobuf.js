...
export const Element = $root.Element = (() => {
    ...
    /**
     * Element type.
     * @member {"audio"|"balloons"|"bokehChart"|"chart"|"dataFrame"|"table"|"deckGlChart"|"docString"|"empty"|"exception"|"imgs"|"map"|"plotlyChart"|"progress"|"text"|"vegaLiteChart"|"video"|undefined} type
     * @memberof Element
     * @instance
     */
    Object.defineProperty(Element.prototype, "type", {
        get: $util.oneOfGetter($oneOfFields = ["audio", "balloons", "bokehChart", "chart", "dataFrame", "table", "deckGlChart", "docString", "empty", "exception", "imgs", "map", "plotlyChart", "progress", "text", "vegaLiteChart", "video"]),
        set: $util.oneOfSetter($oneOfFields)
    });
...
export const NewReport = $root.NewReport = (() => {
     ...
     * @property {string|null} [cwd] NewReport cwd
     * @property {Array.<string>|null} [commandLine] NewReport commandLine
     * @property {string|null} [sourceFilePath] NewReport sourceFilePath
     */
    ...
    /**
     * NewReport sourceFilePath.
     * @member {string} sourceFilePath
     * @memberof NewReport
     * @instance
     */
    NewReport.prototype.sourceFilePath = "";
    ...
    NewReport.encode = function encode(message, writer) {
        ...
        if (message.cwd != null && message.hasOwnProperty("cwd"))
            writer.uint32(/* id 2, wireType 2 =*/18).string(message.cwd);
        if (message.commandLine != null && message.commandLine.length)
            for (let i = 0; i < message.commandLine.length; ++i)
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.commandLine[i]);
        if (message.sourceFilePath != null && message.hasOwnProperty("sourceFilePath"))
            writer.uint32(/* id 4, wireType 2 =*/34).string(message.sourceFilePath);
        return writer;
    };
    ...
    NewReport.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
            ...
            case 3:
                ...
                break;
            case 4:
                message.sourceFilePath = reader.string();
                break;
            default:
                reader.skipType(tag & 7);
                break;
    ...
    NewReport.verify = function verify(message) {
        ...
        if (message.sourceFilePath != null && message.hasOwnProperty("sourceFilePath"))
            if (!$util.isString(message.sourceFilePath))
                return "sourceFilePath: string expected";
        return null;
    };
    ...
    NewReport.fromObject = function fromObject(object) {
        ...
        if (object.sourceFilePath != null)
            message.sourceFilePath = String(object.sourceFilePath);
        return message;
    };
    ...
    NewReport.toObject = function toObject(message, options) {
        ...
        if (message.sourceFilePath != null && message.hasOwnProperty("sourceFilePath"))
            object.sourceFilePath = message.sourceFilePath;
        return object;
    };

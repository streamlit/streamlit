...
import { LibConfigContext } from "@streamlit/core"

import { getCrossOriginAttribute } from "../util/UriUtil"
...
export const useCrossOriginAttribute = (
  ...
  return getCrossOriginAttribute(
    resourceCrossOriginMode as "anonymous" | "use-credentials" | undefined,
    url
  )
}

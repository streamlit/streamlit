...
/**
 * LibConfig properties used by the context. These are based on the
 * server-sent configuration but exclude disableFullscreenMode which
 * is passed as a prop instead for better performance.
 */
export interface LibConfigBase {
  /**
   * Mapbox API token for rendering map visualizations.
   */
  mapboxToken?: string

  /**
   * Whether to enforce opening download links in a new tab.
   */
  enforceDownloadInNewTab?: boolean

  /**
   * Controls the CORS mode for loading media resources.
   */
  resourceCrossOriginMode?: string
}
 ...
 */
export interface LibConfigContextProps extends LibConfigBase {
  /**

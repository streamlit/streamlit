...
import streamlit.lib.delta_generator
...
class StreamlitWriteTest(unittest.TestCase):
    ...
    def test_repr_html(self):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.markdown") as p:
    ...
    def test_dataframe(self):
        ...
        for df in data.values():
            with patch("streamlit.lib.delta_generator.DeltaGenerator.dataframe") as p:
                st.write(df)
    ...
    def test_exception_type(self):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.exception") as p:
    ...
    def test_help(self):
        ...
        # Test module
        with patch("streamlit.lib.delta_generator.DeltaGenerator.help") as p:
            st.write(np)
    ...
    @patch("streamlit.lib.type_util.is_type")
    def test_altair_chart(self, is_type):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.altair_chart") as p:
            st.write(FakeChart())
    ...
    def test_pyplot(self, is_type):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.pyplot") as p:
            st.write(FakePyplot())
    ...
    def test_plotly(self):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.plotly_chart") as p:
    ...
    def test_dict(self):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.json") as p:
            st.write({"a": 1, "b": 2})
    ...
    @patch("streamlit.lib.delta_generator.DeltaGenerator.markdown")
    @patch("streamlit.lib.delta_generator.DeltaGenerator.json")
    ...
    def test_class(self):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.text") as p:
            st.write(SomeClass)
    ...
    def test_exception(self):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.markdown") as m, patch(
            "streamlit.lib.delta_generator.DeltaGenerator.exception",
    ...
    def test_spinner(self):
        ...
        # message.warning
        with patch("streamlit.lib.delta_generator.DeltaGenerator.empty") as e:
    ...
    def test_sidebar(self):
        ...
        with patch("streamlit.lib.delta_generator.DeltaGenerator.markdown") as m, patch(
            "streamlit.lib.delta_generator.DeltaGenerator.help"
        ) as h:

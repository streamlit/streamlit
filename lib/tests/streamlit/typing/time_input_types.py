...
if TYPE_CHECKING:
    ...
    # Test hour_cycle parameter
    assert_type(time_input("label", hour_cycle=12), time)
    assert_type(time_input("label", hour_cycle=24), time)
    assert_type(time_input("label", hour_cycle="localized"), time)

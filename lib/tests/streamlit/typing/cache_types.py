...
if TYPE_CHECKING:
    ...
    @st.cache_data(ttl=1, refresh_type="background")
    def cached_data_fn_background_refresh(arg1: int, arg2: str) -> bool:
        return True

    assert_type(cached_data_fn_background_refresh(1, "2"), bool)
    ...
    @st.cache_resource(ttl=1, refresh_type="background")
    def cached_resource_fn_background_refresh(arg1: int, arg2: str) -> bool:
        return True

    assert_type(cached_resource_fn_background_refresh(1, "2"), bool)

    ...
    [
        ...
        (
            CustomThemeConfig,
            {
                ...
                ("h2_font_weight", FD.LABEL_OPTIONAL, FD.TYPE_INT32),
                ("h3_font_weight", FD.LABEL_OPTIONAL, FD.TYPE_INT32),
                ("h4_font_weight", FD.LABEL_OPTIONAL, FD.TYPE_INT32),
                ("h5_font_weight", FD.LABEL_OPTIONAL, FD.TYPE_INT32),
                ("h6_font_weight", FD.LABEL_OPTIONAL, FD.TYPE_INT32),

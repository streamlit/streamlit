...
class DataFrameSelectorTest(unittest.TestCase):
    def test_legacy_is_default(self):
        ...
        self.assertEqual(
            "legacy", streamlit.get_option("global.dataFrameSerialization")
        )

    @patch.object(DeltaGenerator, "legacy_dataframe")
    @patch.object(DeltaGenerator, "arrow_dataframe")
    ...
    @patch.object(DeltaGenerator, "legacy_table")
    @patch.object(DeltaGenerator, "arrow_table")
    @patch_config_options({"global.dataFrameSerialization": "legacy"})
    ...
    @patch.object(DeltaGenerator, "legacy_line_chart")
    @patch.object(DeltaGenerator, "arrow_line_chart")
    @patch_config_options({"global.dataFrameSerialization": "legacy"})
    ...
    @patch.object(DeltaGenerator, "legacy_area_chart")
    @patch.object(DeltaGenerator, "arrow_area_chart")
    @patch_config_options({"global.dataFrameSerialization": "legacy"})
    ...
    @patch.object(DeltaGenerator, "legacy_bar_chart")
    @patch.object(DeltaGenerator, "arrow_bar_chart")
    @patch_config_options({"global.dataFrameSerialization": "legacy"})
    ...
    @patch.object(DeltaGenerator, "legacy_altair_chart")
    @patch.object(DeltaGenerator, "arrow_altair_chart")
    @patch_config_options({"global.dataFrameSerialization": "legacy"})
    ...
    @patch.object(DeltaGenerator, "legacy_vega_lite_chart")
    @patch.object(DeltaGenerator, "arrow_vega_lite_chart")
    @patch_config_options({"global.dataFrameSerialization": "legacy"})

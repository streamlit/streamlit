...
class DataFrameSelectorTest(unittest.TestCase):
    ...
    def test_arrow_dataframe(self, arrow_dataframe, legacy_dataframe):
        ...
        arrow_dataframe.assert_called_once_with(
            DATAFRAME, 100, 200, use_container_width=False, column_order=None
        )
    ...
    def test_arrow_dataframe_with_snowpark_dataframe(
        ...
        legacy_dataframe.assert_not_called()
        arrow_dataframe.assert_called_once_with(
            snowpark_df, 100, 200, use_container_width=False, column_order=None
        )
    ...
    def test_arrow_dataframe_with_pyspark_dataframe(
        ...
        legacy_dataframe.assert_not_called()
        arrow_dataframe.assert_called_once_with(
            pyspark_dataframe, 100, 200, use_container_width=False, column_order=None
        )
    ...
    def test_arrow_dataframe_with_snowpark_table(
        ...
        legacy_dataframe.assert_not_called()
        arrow_dataframe.assert_called_once_with(
            snowpark_table, 100, 200, use_container_width=False, column_order=None
        )

...
class ArrowTest(testutil.DeltaGeneratorTestCase):
    ...
    @patch("streamlit.lib.type_util.is_pandas_version_less_than", return_value=True)
    ...
    @patch("streamlit.lib.type_util.is_pandas_version_less_than", return_value=False)
    @patch.object(Styler, "_translate")

...
SVG_TEST_CASES = [
    ...
    SvgTestCase(
        ...
        '<svg viewBox="{x} 0 100 90" xmlns="http://www.w3.org/2000/svg" width="100"> <rect x="0" y="0" width="100" height="90" fill="yellow" /> <rect x="100" y="0" width="100" height="90" fill="green" /> </svg>',
        True,
        "100",
    ),
    SvgTestCase(
    ...
    SvgTestCase(
        ...
        '<svg viewBox="0 0 160 40" xmlns="http://www.w3.org/2000/svg" width="160"> <a href="https://developer.mozilla.org/"> <text x="10" y="25">MDN Web Docs</text> </a> </svg>',
        True,
        "160",
    ),
]
...
class ImageProtoTest(testutil.DeltaGeneratorTestCase):
    ...
    def test_get_svg_width(self, image_markup: str, expected_width: Optional[str]):
        self.assertEqual(image._get_svg_width(image_markup), expected_width)
    ...
    def test_normalize_svg(self, image_markup: str, normalized_markup: str):
        print(
            f"original: \n {image_markup} \n normalized: \n {image._normalize_svg(image_markup)} \n"
        )

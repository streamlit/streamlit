...
from streamlit.runtime.credentials import _Activation
from streamlit.runtime.credentials import Credentials
from streamlit.runtime.credentials import _verify_email
...
class CredentialsClassTest(unittest.TestCase):
    ...
    @patch("streamlit.runtime.credentials.file_util.get_streamlit_file_path", mock_get_path)

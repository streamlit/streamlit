...
- **Examples**: Use `.. code-block:: python` for examples. Where possible, make the examples fully
  ...
  directive should include a height of at least 200px and usually not more than 600px. Set the height to
  avoid vertical scrolling when possible. Always include a full empty line after an RST directive.

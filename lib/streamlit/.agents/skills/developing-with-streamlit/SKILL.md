...
| **Coloring text with an exact hex / CSS color** — arbitrary inline text color via `:color[text]{foreground="#hex"}` (no raw HTML), beyond the named `:red[...]` palette | read `references/markdown.md` |

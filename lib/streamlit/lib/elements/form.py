...
from streamlit.lib.scriptrunner import ScriptRunContext, get_script_run_ctx
...
def _current_form(
    this_dg: "streamlit.lib.delta_generator.DeltaGenerator",
) -> Optional[FormData]:
...
def current_form_id(dg: "streamlit.lib.delta_generator.DeltaGenerator") -> str:
...
def is_in_form(dg: "streamlit.lib.delta_generator.DeltaGenerator") -> bool:
...
class FormMixin:
    ...
    @property
    def dg(self) -> "streamlit.lib.delta_generator.DeltaGenerator":
        """Get our DeltaGenerator."""
        return cast("streamlit.lib.delta_generator.DeltaGenerator", self)

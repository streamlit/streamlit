...
import streamlit.lib.watcher
from streamlit.lib import config
from streamlit.lib import env_util
from streamlit.lib.logger import get_logger
from streamlit.lib.watcher.polling_path_watcher import PollingPathWatcher

LOGGER = get_logger(__name__)

try:
    # Check if the watchdog module is installed.
    from streamlit.lib.watcher.event_based_path_watcher import EventBasedPathWatcher
...
PathWatcherType = Union[
    Type["streamlit.lib.watcher.event_based_path_watcher.EventBasedPathWatcher"],

...
import streamlit.lib.elements.exception as exception_utils
from streamlit import __version__, secrets
from streamlit.lib import caching, legacy_caching, source_util, config
from streamlit.lib.case_converters import to_snake_case
...
from streamlit.lib.metrics_util import Installation
from streamlit.lib.proto.ClientState_pb2 import ClientState
from streamlit.lib.proto.ForwardMsg_pb2 import ForwardMsg
from streamlit.lib.proto.GitInfo_pb2 import GitInfo
from streamlit.lib.proto.NewSession_pb2 import (
    Config,
    CustomThemeConfig,
    NewSession,
    UserInfo,
)
from streamlit.lib.proto.PagesChanged_pb2 import PagesChanged
...
if TYPE_CHECKING:
    from streamlit.lib.state import SessionState
...
class AppSession:
    ...
    def handle_git_information_request(self) -> None:
        ...
        try:
            from streamlit.lib.git_util import GitRepo

    ...
    def number_input(
        ...
        *,  # keyword-only arguments:
        ...
        value : int, float, or None
            The value of this widget when it first renders. If None,
            the number input will be empty and return None as long as the user
            hasn't changed it. Defaults to min_value, or 0.0 if min_value is None.

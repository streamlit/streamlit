...
class LayoutsMixin:
    ...
    def container(
        ...
        *,
        ...
        gap : int, "xxsmall", "xsmall", "small", "medium", "large", "xlarge", "xxlarge", or None
            ...
            - An integer: A fixed pixel gap between the elements.
    ...
    def columns(
        ...
        *,
        ...
        gap : int, "xxsmall", "xsmall", "small", "medium", "large", "xlarge", "xxlarge", or None
            ...
            - An integer: A fixed pixel gap between the columns.

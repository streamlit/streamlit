...
BASIC_REQUIRED_COMPONENTS = (
    ("cartesian_grid", {"stroke": "#E6E9EF"}),
    ("x_axis", {"stroke": "#101620", "data_key": dict_builder.INDEX_COLUMN_NAME}),
    ("y_axis", {"stroke": "#101620"}),
    ("tooltip", {}),
    ("legend", {}),
)
...
REQUIRED_COMPONENTS = {
    ...
    "composed_chart": (BASIC_REQUIRED_COMPONENTS,),
}

...
class CachedMessageReplayContext:
    """A utility for storing messages generated by `st` commands called inside
    a cached function.

    Context-local state keeps concurrent threads and asyncio tasks isolated while
    allowing child tasks created inside a cached function to contribute messages to
    their parent's capture.
    """
    ...
    def calling_cached_function(self, func: Callable[..., Any]) -> Iterator[None]:  # noqa: ARG002
        ...
        in_cached_function_token = in_cached_function.set(True)

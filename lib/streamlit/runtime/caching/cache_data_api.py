    ...
    def _decorator(
        ...
        *,
        ...
        task : bool
            ...
            immediately with a handle exposing ``running``, ``done``, ``error``, and
            ``result``. Streamlit reruns the app when the function finishes. Apps
            requesting the same value at the same time share a single computation,
            and every one of them reruns when it finishes.

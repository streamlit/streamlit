...
# Type alias for the bind parameter on widgets.
# Currently only supports "query-params" for URL query parameter synchronization.
BindOption: TypeAlias = Literal["query-params"]

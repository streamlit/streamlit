...
class DeltaGenerator(object):
    ...
    def show(self, *args):
        ...
        Show() has similar properties to write():
            ...
            1. You can pass in multiple arguments, all of which will be
            debugged.
        ...
        *args : any
        ...
        - When passing multiple arguments the inclusion of `,` or `)` in a
         string argument may cause an error.
        ...
        try:
            ...
            if not lines:
                self.warning("`show` not enabled in the shell")
                return
    ...
    def write(self, *args, **kwargs):
        ...
        *args : any
        ...
        from streamlit import _DATAFRAME_LIKE_TYPES, _HELP_TYPES
        ...
        try:
            ...
            for arg in args:
                ...
                elif (type(arg) in dict_types) or (
    ...
    def spinner(self, text="In progress..."):
        ...
        try:
            ...
            add_report_ctx(threading.Timer(DELAY_SECS, set_message)).start()
    ...
    def echo(self):
        ...
        try:
            ...
            with open(filename) as source_file:
                ...
                initial_spaces = spaces_re.match(lines_to_display[0]).end()
                for line in source_lines[end_line:]:
                    if spaces_re.match(line).end() < initial_spaces:
                        break

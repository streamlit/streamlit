...
# Config Section: Host config #

_create_section("host", "Configurations related to the host environment.")

_create_option(
    "host.disableUnsafeHtmlExecution",

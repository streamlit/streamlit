...
SNOWPARK_CONDA_EXCLUDED_DEPENDENCIES = [
    ...
    # "pydeck>=0.1.dev5, <1", # HACK: For stlite, comment out as it's not Pyodide-compatible
    ...
    # "tornado>=6.0.3, <7", # HACK: For stlite, comment out as it's not Pyodide-compatible
]

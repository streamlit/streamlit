...
- **(Python) Type Tests**: Verify public API typing with `assert_type`, checked by mypy and ty via `make python-types` (not run by pytest). Located at `lib/tests/streamlit/typing/<command>_types.py`.

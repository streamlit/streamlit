...
def test_altair_chart_displays_correctly(
    ...
    # assert_snapshot(charts.nth(5), name="st_altair_chart-grouped_bar_chart_default_theme")  # ruff:ignore[commented-out-code]
    # assert_snapshot(charts.nth(5), name="st_altair_chart-grouped_bar_chart_streamlit_theme")  # ruff:ignore[commented-out-code]
    # assert_snapshot(charts.nth(5), name="st_altair_chart-grouped_use_container_width_default_theme")  # ruff:ignore[commented-out-code]
    assert_snapshot(

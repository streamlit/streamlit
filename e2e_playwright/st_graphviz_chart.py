...
# Verify that Graphviz record-node padding stays balanced when labels use its
# own font metrics (#7397).
_medium_record_label = (
...
with st.container(key="dangerous_link_sanitization"):

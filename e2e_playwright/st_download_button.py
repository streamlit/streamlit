...
# Test callable data support
def generate_data() -> str:
    """Callable that generates data for download."""
    return "Data generated by callable function"


st.download_button(
    "Download with callable data",
    data=generate_data,
    file_name="callable_data.txt",
    key="callable_download_button",
)

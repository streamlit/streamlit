...
st.dataframe(
    ...
    column_config={
        ...
        # stay stable:
        # "distance": st.column_config.DatetimeColumn(format="distance"),  # ruff:ignore[commented-out-code]
    },
    hide_index=True,
    width="content",
)

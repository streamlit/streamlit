...
def test_data_editor_supports_various_configurations(
    ...
    assert_snapshot(elements.nth(9), name="st_data_editor-ignore_options")
    assert_snapshot(elements.nth(10), name="st_data_editor-text_column")
    assert_snapshot(elements.nth(11), name="st_data_editor-number_column")
    assert_snapshot(elements.nth(12), name="st_data_editor-checkbox_column")
    assert_snapshot(elements.nth(13), name="st_data_editor-selectbox_column")
    assert_snapshot(elements.nth(14), name="st_data_editor-link_column")
    assert_snapshot(elements.nth(15), name="st_data_editor-datetime_column")
    assert_snapshot(elements.nth(16), name="st_data_editor-date_column")
    assert_snapshot(elements.nth(17), name="st_data_editor-time_column")
    assert_snapshot(elements.nth(18), name="st_data_editor-progress_column")
    assert_snapshot(elements.nth(19), name="st_data_editor-list_column")
    assert_snapshot(elements.nth(20), name="st_data_editor-bar_chart_column")
    assert_snapshot(elements.nth(21), name="st_data_editor-line_chart_column")
    assert_snapshot(elements.nth(22), name="st_data_editor-image_column")

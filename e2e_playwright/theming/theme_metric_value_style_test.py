...
def configure_metric_value_style():
    """Configure custom metric value font size and weight."""
    os.environ["STREAMLIT_THEME_METRIC_VALUE_FONT_SIZE"] = "48"
...
def test_metric_value_custom_font_size_and_weight(app: Page):
    """Test that custom metric value font size and weight are applied."""
    expect_no_skeletons(app, timeout=25000)

    metric = get_metric(app, "Revenue")
    metric_value = metric.get_by_test_id("stMetricValue")

    # Verify custom font size is applied (48px)

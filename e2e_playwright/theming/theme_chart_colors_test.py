...
def _select_theme(app: Page, theme_name: str) -> None:
    ...
    After selecting, the page is reloaded so that Plotly charts re-resolve
    placeholder colors against the newly active theme.
    """
    ...
    # Reload so Plotly charts re-resolve placeholders with the new theme.
    app.reload()
    expect_no_skeletons(app, timeout=25000)
